...
More information about this project can be found [here](http://www.blogs.hss.ed.ac.uk/gestalt-structure-phenomenology/). For videos of the talks from project's first conference, which took place in December 2016, go [here](http://www.blogs.hss.ed.ac.uk/gestalt-structure-phenomenology/2016/12/15/dec-3-conference-videos/).
