...
(<a href="javascript:;" onclick="return toggleMe('para3')" value="Toggle"><u>Abstract</u></a>) (<a href="javascript:;" onclick="return toggleMe('para4')" value="Toggle"><u>Handout</u></a>)
...
<span id="para13" class="toggle abstract">One of the central objections to Russell’s multiple relation theory of judgement is that it cannot distinguish between different judgements involving non-symmetric relations. This has come to be known as the narrow direction problem. I want to diagnose why this problem arises for Russell’s view, explain what he can say in response to it, and then look at whether the problem arises, and the response works, when it comes to other theories of judgement.</span>
